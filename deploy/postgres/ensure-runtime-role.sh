...
WITH grants(role_name, table_name) AS (
  VALUES
    ...
    (:'mcp_user', 'data_sync_runs'),
    (:'mcp_user', 'mcp_tool_configs'),
    (:'mcp_user', 'mcp_tool_definitions'),
    (:'mcp_user', 'opportunity_experience_weight_policies'),
    (:'mcp_user', 'dim_person'),
    (:'mcp_user', 'dim_customer'),
    (:'mcp_user', 'fact_opportunity'),
    (:'mcp_user', 'fact_opportunity_participant'),
    (:'mcp_user', 'fact_opportunity_product'),
    ...
    (:'assistant_worker_user', 'conversation_organization_scopes'),
    ...
    (:'assistant_worker_user', 'mcp_tool_definitions'),
    (:'assistant_worker_user', 'memories'),
    (:'assistant_worker_user', 'executive_personal_profiles'),
    (:'assistant_worker_user', 'harness_config_versions'),
    (:'assistant_worker_user', 'harness_stage_runs'),
    ...
    (:'ingestion_user', 'opportunity_experience_weight_policies'),
    (:'ingestion_user', 'dim_person'),
    (:'ingestion_user', 'dim_customer'),
    (:'ingestion_user', 'fact_opportunity'),
    (:'ingestion_user', 'fact_opportunity_participant'),
    (:'ingestion_user', 'fact_opportunity_product'),
...
WITH grants(role_name, privileges, table_name) AS (
  VALUES
    ...
    (:'assistant_worker_user', 'UPDATE', 'memories'),
    (:'assistant_worker_user', 'INSERT, UPDATE', 'harness_stage_runs'),
    ...
    (:'ingestion_user', 'INSERT, UPDATE', 'opportunity_experience_weight_policies'),
    ...
    (:'ingestion_user', 'INSERT', 'fact_opportunity_participant'),
    (:'ingestion_user', 'INSERT', 'fact_opportunity_product'),
